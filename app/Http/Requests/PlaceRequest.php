...
class PlaceRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'latitude.numeric' => 'La latitud debe contener un valor numérico.',
            'latitude.between' => 'La latitud ingresada está fuera del rango válido.',
            'longitude.numeric' => 'La longitud debe contener un valor numérico.',
            'longitude.between' => 'La longitud ingresada está fuera del rango válido.',
